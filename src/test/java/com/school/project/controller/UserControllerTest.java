...
public class UserControllerTest {
    ...
    @Test
    public void testUpdateUserLehrer() throws Exception {
    ...
    @Test
    public void testGetAllUsersLehrer() throws Exception {
    ...
    private List<User> getAllUsers() {
        ...
        userList.add(new User( "Ivan", "Ivanov", new Date(), "ivan_@mail.ru", "+49333300"));
...
return userList;
    ...
    private User getUpdatedUser() {
        ...
        return new User( "Tanya", "Pawlova", date, "ivan@mail.ru", "178912");
    }
